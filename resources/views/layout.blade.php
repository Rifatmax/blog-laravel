  ...
  <div class="container-fluid">
	...
	@if(Auth::user())
      ...
      <a class="navbar-brand" href="#">Home</a>
       ...
       <li class="active"><a href="/allpost"> Recent Posts</a></li>	
   ...
   <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" >
      <div class="item active" >
       <img src="{{asset('images/p1.png')}}" alt="Logo" style="Height:500px; width:100%;"/>
      </div>
     <div class="item"style="Height:30%; width:100%;">
         <img src="{{asset('images/p2.jpg')}}" alt="Logo" style=" Height:500px; width:100%;"/>
      </div>
      <div class="item"style="Height:30%; width:100%;">
         <img src="{{asset('images/p3.jpg')}}" alt="Logo" style=" Height:500px;width:100%;"/>
      </div>
...
<a style="color:white; float:right;" href="{{URL::to('/register')}}">Click to Become a blog </a></h2></p>
</div>
</body>
</html>
